...
#ifndef COLIN_PDDL_PENDINGPROPOSITION_H_
#define COLIN_PDDL_PENDINGPROPOSITION_H_
...
public:
	...
	friend std::ostream & operator<<(std::ostream & output,
			const PendingProposition & pendingProposition);
};

}

#endif /* COLIN_PDDL_PENDINGPROPOSITION_H_ */
