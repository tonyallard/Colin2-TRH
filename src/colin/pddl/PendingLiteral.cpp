...
std::string PendingLiteral::toActionString() {
	...
	std::list<std::pair<Literal, std::pair<VAL::time_spec, bool> > >::const_iterator condItr = postconditions.begin();
	const std::list<std::pair<Literal, std::pair<VAL::time_spec, bool> > >::const_iterator condItrEnd = postconditions.end();
